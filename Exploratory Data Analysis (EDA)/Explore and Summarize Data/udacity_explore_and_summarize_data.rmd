Financial Contributions to Presidential Campaigns in NY by Luiz Henrique Quevedo Lima
===================================================================================================
...
### <strong>Map plotting</strong>

#### Making use of the geolocation data we extracted for each city in a previous section, let's plot this data over a map graph to get a different view of the contributions for the top 3 candidates.
...
#### As we can see on the graph above, there are a lot of green points plotted, which indicates the contribution amount received by Hillary. The size of the bubble is a factor of the amount received. There are also areas dominated by Sanders (orange bubbles) and Trump (purple bubbles).

# <strong>Final Plots and Summary</strong>

### <strong>Plot One</strong>
...
#### This plot shows the total contribution amount for all candidates (in percentage). The most important information we extracted from it is the top 3 presidentials who received the most contributions, which are Hillary Clinton, Bernard Sanders, and Donald Trump. We have used this information throughout our analysis.


### <strong>Plot Two</strong>
...
#### This graph shows about the occupation of those who contributed to the 2016 presidential campaign. It's important to note that the top 3 occupation are being skewed by the top 3 candidates: Attorney, Not Employed and Retired. In a previous analysis, we saw that these occupations are the most common for people who donated to Hillary, Sanders and Trump, respectivelly.


### <strong>Plot Three</strong>
...
#### Finally, this is perhaps the most informative plot we created. As we discussed in previous sections, the date feature introduced valuable information to our analysis and also motivated us to look up the news (from back then) to understand more about this distribution. With this plot only, we we able to spot ups and downs, trends, seasonality and range of the contributions amount. Summarizing: how data moved over time!
